...
void spotify_show_current_song(struct scpotify_context *);
void spotify_display_tops(struct scpotify_context *);
void cleanup_playlist(scpotify_context *);
void change_playlist_to_play_command(scpotify_context *);
void spotify_play_playlist(struct scpotify_context *);
void build_related_artist_url(scpotify_context *);
void cleanup_related_artists(scpotify_context *);
void spotify_show_related_artists(struct scpotify_context *);
void spotify_play_song(struct scpotify_context *, struct spotify_song_query_info);
void spotify_play_searched_artist(struct scpotify_context *, struct spotify_song_query_info);
...
void spotify_add_song_queue(struct scpotify_context *, struct spotify_song_query_info);
void spotifyC(struct scpotify_context *, struct spotify_song_query_info);
